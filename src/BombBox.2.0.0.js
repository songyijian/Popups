...
class BombBox{
  constructor(contentString, config = {}){
    ...
    this.config = config
    this.live= 0 ;   // 0=dom不存在创建 | 1=创建并插入了指定位置
    // this.show = 0;    // 0 处于曝光状态
  ...
  _init_(){
    ...
    if (this.config.bg) {
      ...
      this.config.append.appendChild(this.bombBg);
    };

    if(!this.config.initshow){
      this.bombDocument.style.display="none";
      this.bombBg && (this.bombBg.style.display="none");
    }

    if(this.config.initshow){//当前DOM状态
      this.show()
    }
  }
...
//                 } else if (keyCode === 27) {
//                     _this.close(_this.dataJ.form);
//                 }
//             }
//         }
//         if (this.bombClose)
//             this.bombClose.onclick = function() { _this.close(_this.dataJ.form) };
//         if (this.bombNoBtn)
//             this.bombNoBtn.onclick = function() { _this.close(_this.dataJ.form) };
//         if (this.bombYesBtn)
...
//     BombBox.prototype.createDom = function(type) {
//         this.bombDocument = document.createElement('div');
//         this.bombClose = document.createElement('big');
//         this.bombHtml = document.createElement('div');
//         this.bombClose.className = 'bomb_closebtn';
...
//             this.bombBg = document.createElement('div');
//             this.bombBg.className = 'bomb_bg';
//             if(!this.dataJ.initStatus)
//                 this.bombBg.style.display="none";
...
//         if(!this.dataJ.initStatus){//当前DOM状态
//             this.disStatus=1; 
//         }else{
//             this.disStatus=2;
//         }
...
//         if(this.disStatus === 1){
//             this.disStatus=2;
//             if(this.bombBg)this.bombBg.style.display="block";
//             this.bombDocument.style.display="block";
//         }
//         return this;
//     }

//     BombBox.prototype.html = function(t, fn) { this.bombHtml.innerHTML = t; if (fn) fn(this);return this; }

//     BombBox.prototype.yesFn = function(This, type) {
//         var _value = true;
//         this.close(this.dataJ.form);
//         if (type === "prompt" || type === "textarea") {
...
//         this.bombDocument.style.top = 0;// 'top:0;left:0; bottom:0; right:0; margin:auto;'
//         this.bombDocument.style.left = 0;
//         this.bombDocument.style.bottom = 0;
//         this.bombDocument.style.right = 0;
//         this.bombDocument.style.margin = 'auto';
//         if (fn) { fn() }
//         return this;
//     };

//     //关闭
//     BombBox.prototype.close = function(type) {
//         if( type === 'stick' ){
//             this.bombBg.style.display="none";
//             this.bombDocument.style.display="none";
//             this.disStatus=1;
...
//     module.exports = window.BombBox;
// } else if (typeof define === 'function' && define.amd) {
//     define([], function() {
//         'use strict';
//         return window.BombBox;
//     });
// }