...
! function() {
    ...
    BombBox.prototype.html = function(t) { this.bombHtml.innerHTML = t; }
    ...
    BombBox.prototype.center = function(fn) {
        ...
        this.documentSzie = this.bombDocument.getBoundingClientRect()
        this.bombDocument.width = this.documentSzie['width'];
        this.bombDocument.height = this.documentSzie['height'];
